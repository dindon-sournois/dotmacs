...
TODO: refactorise this shit

#+BEGIN_SRC emacs-lisp
(defun me/sort-lines (beg end)
  (interactive "r")
  (setq-local sort-fold-case t)
  (sort-lines nil beg end))
(defun me/sort-lines-case (beg end)
  (interactive "r")
  (setq-local sort-fold-case nil)
  (sort-lines nil beg end))
(defun me/sort-lines-reverse (beg end)
  (interactive "r")
  (setq-local sort-fold-case t)
  (sort-lines t beg end))
(defun me/sort-lines-case-reverse (beg end)
  (interactive "r")
  (setq-local sort-fold-case nil)
  (sort-lines t beg end))
(defun me/sort-paragraphs (beg end)
  (interactive "r")
  (setq-local sort-fold-case t)
  (sort-paragraphs nil beg end))
(defun me/sort-paragraphs-case (beg end)
  (interactive "r")
  (setq-local sort-fold-case nil)
  (sort-paragraphs nil beg end))
(defun me/sort-paragraphs-reverse (beg end)
  (interactive "r")
  (setq-local sort-fold-case t)
  (sort-paragraphs t beg end))
(defun me/sort-paragraphs-case-reverse (beg end)
  (interactive "r")
  (setq-local sort-fold-case nil)
  (sort-paragraphs t beg end))
#+END_SRC
...
** Spacemacs XXX: remove me
*** Core

Install spacemacs dependencies.

#+BEGIN_SRC emacs-lisp2
(use-package validate)
(use-package hydra)
(use-package page-break-lines)
#+END_SRC

Add spacemacs files to path and load core functions.

#+BEGIN_SRC emacs-lisp2
(load (concat user-emacs-directory "lisp/spacemacs/core/core-versions.el"))
(load (concat user-emacs-directory "lisp/spacemacs/core/core-load-paths.el"))
(require 'core-spacemacs)
#+END_SRC

#+BEGIN_SRC emacs-lisp2
(require 'core-transient-state)
(spacemacs|define-transient-state paste-mode
        :title "Paste Transient State"
        :doc "
 [_j_/_k_] down/up        [_Q_] quit twitter"
        :bindings
        ("?"          nil :exit t)
        ("C-j"        evil-paste-pop-next)
        ("C-k"        evil-paste-pop))
...
To disable loading of unused graphical components add this snippet of code into
your =~/.Xressources= file:

#+BEGIN_SRC conf
! disable emacs loading of unused components emacs.menuBar: off emacs.toolBar:
off emacs.verticalScrollBars: off
#+END_SRC
...
;; (advice-add 'lsp-find-locations :around #'me//evil-set-jump)
;; (advice-add 'lsp-show-xref :around #'me//evil-set-jump)
...
(use-package org
  ...
  ;;(org-descriptive-links nil) ; TODO: toggle
...
(me/leader-def
  ...
  "=slc" 'me/sort-lines-case
  "=slC" 'me/sort-lines-case-reverse
  "=sll" 'me/sort-lines
  "=slL" 'me/sort-lines-reverse
  "=sp"  '(:ignore t :which-key "sort paragraphs")
  "=spc" 'me/sort-paragraphs-case
  "=spC" 'me/sort-paragraphs-case-reverse
  "=spp" 'me/sort-paragraphs
  "=spP" 'me/sort-paragraphs-reverse)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(me/leader-def
  "q"  '(:ignore t :which-key "quit1")
  "qq" 'me/prompt-kill-emacs
  "qQ" 'kill-emacs
  "qz" 'me/prompt-kill-frame
  "qZ" 'me/kill-frame)
#+END_SRC
